...
var HotTable = (function () {
    function HotTable(element, ngZone) {
        ...
        htEventNames.forEach(function (eventName) {
            _this[eventName] = new EventEmitter();
        });
    }
    HotTable.prototype.getHandsontableInstance = function () {
        return this.inst;
    };
